...
public static void main(String[] args) throws InterruptedException {
		...
		WebDriver driver=SeleniumUtility.setUp("chrome","https://opensource-demo.orangehrmlive.com/web/index.php/auth/login");
		     ...
		     driver.findElement(By.xpath("//div[@class='oxd-grid-2 orangehrm-full-width-grid']//div[2]//input")).sendKeys("1234");
		     
		     driver.findElement(By.xpath("//div[@class='oxd-form-actions']//button[2]")).click();
		     
		    driver.findElement(By.xpath("//ul[@class='oxd-main-menu']//li[2]//a")).click();
		    
	      driver.findElement(By.xpath("//div[@class='oxd-form-row']//div[2]//div[2]//input")).sendKeys("03061234");
		    
	       driver.findElement(By.xpath("//button[@type='submit']")).click();
	 //   Thread.sleep(2000);
	         
		     driver.findElement(By.xpath("//div[@class='oxd-table-body']//div//div[@class='oxd-table-cell oxd-padding-cell']//div//label//span//i")).click();
		     ...
		     driver.findElement(By.xpath("//div//button[@class='oxd-button oxd-button--medium oxd-button--secondary orangehrm-left-space']")).click();
		     driver.findElement(By.xpath("//ul[@class='oxd-main-menu']//li[2]//a")).click();
		     
		     
		      driver.findElement(By.xpath("//div[2][@class='oxd-grid-item oxd-grid-item--gutters']//input")).sendKeys("03061234");
			    
		       driver.findElement(By.xpath("//button[@type='submit']")).click();
		       
		       driver.findElement(By.xpath("//div[@class='oxd-table-header-cell oxd-padding-cell oxd-table-th' and @role='columnheader']")).click();
		       
		       driver.findElement(By.xpath("//div[@class='oxd-table-cell-actions']/button[@class='oxd-icon-button oxd-table-cell-action-space']")).click();
