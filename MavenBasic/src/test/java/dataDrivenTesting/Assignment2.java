...
public class Assignment2 extends SeleniumUtility {
	...
	public void VtigerLogin() {
			...
			if(getCurrentTitleOfApplication("vtiger").equals("Dashboard")) {
				ExcelUtility.updateExcelContent(".\\src\\test\\resources\\testData\\AppTest.xlsx", "Sheet2", 2, 5,"Passed");
				
				ExcelUtility.updateExcelContent(".\\src\\test\\resources\\testData\\AppTest.xlsx", "Sheet2", 2, 4,"vtiger");
			}else {
				ExcelUtility.updateExcelContent(".\\src\\test\\resources\\testData\\AppTest.xlsx", "Sheet2", 2, 5,"Failed");
